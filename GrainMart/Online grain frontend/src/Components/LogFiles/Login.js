...
import login1 from "./logingrain3.png";
...
const Login = () => {
  ...
  const addData = async (add) => {
    ...
    let result = await axios.post(config.serverUrl + `/user/UserLogin`, user);
    console.log("hello");
    ...
    if (email.trim() === " " || password.trim() === " ") {
      ...
      if (result.data.data.status === "Active") {
        ...
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: "You are temporarily block! Please contact: 8698712734",
        });
      }
    }
  };
              ...
              <div className="col-lg-7">
                <div className="m-auto w-75 pt-3 pb-3 align-self-center ">
                  ...
                  <form className="row g-3 mt-3">
                    ...
                    <a href="emailVerify" style={{paddingLeft:"30px"}}> 
                    <button
                                  type="button"
