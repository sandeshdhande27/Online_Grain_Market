...
public interface ProductRepository extends JpaRepository<Product, Integer>{
	...
	@Transactional
	@Modifying
	@Query("UPDATE Product p SET p.categories=:c, p.imageName=:i, p.price=:price, p.productName=:productname, p.stocks=:stock WHERE p.pid =:id")
...
//	@Query("select p from products p where p.pid= :p")//
//	public Product findById(@Param("p") int pid);
